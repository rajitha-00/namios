...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "A research-led NamiOS built by DesignNetrix, Colombo, Sri Lanka for independent properties.",
  ...
  twitter: {
    ...
    title: "About NamiOS — Hotel Software Built in Sri Lanka",
    description: "Research-led NamiOS for Sri Lankan independent hotels, villas & resorts. By DesignNetrix, Colombo.",
