      ...
      <section className="not-found-hero">
        <div className="container not-found-layout">
          <div className="not-found-copy">
            ...
            <p>The address may have changed, or the page may no longer be available. The NamiOS platform is still right where you left it.</p>
            <div>
          ...
          <div className="not-found-visual" aria-hidden="true">
            <div className="room-key"><span>404</span><strong>ROOM NOT FOUND</strong><small>NamiOS · Front desk</small></div>
            <div className="key-ring" />
            <div className="not-found-note">Try another route <span>→</span></div>
          </div>
        </div>
      </section>
